#!/usr/bin/env node
/**
 * One-time setup script: adds the OnboardingChecklist tab (with header row)
 * to the spreadsheet used by lib/googleSheets.ts's main-sheet tabs
 * (GOOGLE_MAIN_SHEET_ID). Safe to re-run — skips creation if the tab already
 * exists and never touches any other tab.
 *
 * Usage:
 *   node scripts/setup-onboarding-checklist-tab.js
 *
...
const TAB_NAME = "OnboardingChecklist";
const HEADERS = [
  "AccountId",
  "AccountName",
  "ItemsJson",
