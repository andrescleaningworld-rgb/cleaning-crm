#!/usr/bin/env node
/**
 * One-time setup script: adds the GeocodeCache tab (with header row) to the
 ...
 *
 * Usage:
 *   node scripts/setup-geocode-cache-tab.js
 *
...
const TAB_NAME = "GeocodeCache";
const HEADERS = ["Address", "Latitude", "Longitude", "GeocodedAt"];
