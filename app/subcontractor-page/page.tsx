...
export default function SubcontractorPortalPage() {
  ...
  function getFilteredSuppliesForLine(line: OrderLineItem) {
    if (!line.category) return activeSupplyItems;
                          ...
                          {(selectedSupply || isOther) ? (
                            <div>
                              ...
                              <textarea
                                ...
                                className={
                                  isOther
                                    ? "mt-2 w-full rounded-2xl border border-slate-300 px-4 py-3 text-base outline-none focus:border-blue-600"
                                    : "mt-2 w-full rounded-2xl border border-slate-200 bg-slate-100 px-4 py-3 text-base text-slate-600"
                                }
                                required={isOther}
                              />
                            </div>
