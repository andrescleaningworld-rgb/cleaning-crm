...
function getConditionClass(value: any): string {
  ...
  useEffect(() => {
    async function loadVisits() {
      try {
        ...
        const loadedVisits = Array.isArray(data.visits)
          ? data.visits
    ...
    <main className="min-h-screen bg-gray-50 p-6 text-gray-900">
      <div className="mb-6 flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
        <div>
          ...
          <h1 className="mt-2 text-3xl font-bold">Visits</h1>
        ...
        <>
          <section className="mb-5 grid grid-cols-1 gap-4 md:grid-cols-3">
            ...
            <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
              ...
              <p className="mt-2 text-sm text-gray-500">After search filter</p>
            </div>
          ...
          <section className="mb-5 rounded-2xl border border-gray-200 bg-white p-4 shadow-sm">
            <input
              ...
              placeholder="Search visits by account, manager, subcontractor, type, or notes..."
